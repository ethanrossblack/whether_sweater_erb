...
describe "Forecast API" do
  ...
  it "serializes a Forecast PORO into formatted JSON" do
    VCR.use_cassettes(@cassettes) do
      forecast = ForecastFacade.new({location: "denver,co"}).forecast
      ...
      serialized_forecast = forecast_serializer.to_hash
  
      expect(serialized_forecast).to be_a Hash
      expect(serialized_forecast).to have_key :data
      expect(serialized_forecast[:data]).to be_a Hash

      forecast_data = serialized_forecast[:data]
